...
| 2026-04-29 | soccermaster-wiring-probe | 9c0020e | 4 SynLoc images | HF Jobs `l4x1` | `cloud/soccermaster_wiring_probe.py` | 0.000 | 0.000 | $2.00 est | 3m | mismatch | Job `69f229c4d70108f37ace174a` loaded weights and ran CUDA inference, but raw roles were `ball=1120`, `staff=80`, `athlete_like_at_conf_0_05=0`. This is a SoccerMaster config/runtime/decode mismatch, not model underperformance. Future tiny probes must use `t4-small` unless a documented T4 failure justifies escalation. |
