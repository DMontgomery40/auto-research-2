...
- Official SoccerMaster role mapping is `ball=0`, `goalkeeper=1`, `other=2`, `player=3`, `referee=4`, `None=5`. The copied adapter mapped id `3` to `ball` and id `4` to `staff`, so the last probe likely had `player=1120` and `referee=80`. The next bounded test is a cheap T4 rerun with official role labels, then a tiny SynLoc conversion/eval probe.
